                ...
                <div className="form">
                    <form className="fm space-y-10">
                        ...
                        <div className="flex flex-col justify-center items-center space-y-3">
                            <button type="submit" className="bg-[#010130] py-2 px-16 rounded text-white font-semi-bold hover:bg-transparent hover:border-2 transition ease-in-out duration-300">Log-In</button>
